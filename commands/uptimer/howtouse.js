...
module.exports = {
  ...
  run: async (client, message, args ) => {
      //--------------------------------------S T A R T---------------------------------------
        ...
        .setTitle(`${emoji.discordlogo} How to Use Uptimer!`)
        .addField(`${emoji.discordlogo} **Get the link**`,
      ...
      .setTitle(`${emoji.discordlogo} How to Use Uptimer!`)
      .addField(`${emoji.discordlogo} **Run the command**`,
      ...
      .setTitle(`${emoji.discordlogo} How to Use Uptimer!`)
      .addField("**Other Commands**","Now that we have added your project, you can use other command such as `projects` `remove` `stats` and `total`. Below Is an image of the remove command")
