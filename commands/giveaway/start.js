...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if(!giveawayChannel) return message.reply(`${emoji.error} You need to specify a channel!`)
        ...
        if(isNaN(giveawayNumberWinners) || (parseInt(giveawayNumberWinners) <= 0)){
            return message.channel.send(` ${emoji.error} You have to specify a valid number of winners!`);
        }
