    ...
    run: async (client, message, args) => {
        ...
        if (!word) {
            let embed = new Discord.MessageEmbed()
                ...
                .setDescription(`${emoji.error} **Invalid Usage\ndelword(word)\nExample:\ndelword fuck**`)
        ...
        if (database) {
            ...
            let unabletofind = new Discord.MessageEmbed()
                ...
                .setDescription(`${emoji.error} **I could not find that word in the database.*`)
                .setAuthor(`${message.author.username}`, `${message.author.avatarURL({dynamic:true})}`)
            ...
            let deleted = new Discord.MessageEmbed()
                ...
                .setDescription(`${emoji.sucess} **Deleted ${word} from Anit-WordList!** `)
                .setAuthor(`${message.author.username}`, `${message.author.avatarURL({dynamic:true})}`)
            ...
            let okelse = new Discord.MessageEmbed()
                ...
                .setDescription(`${emoji.error} **Sorry, I am unable to find that word.**`)
                .setAuthor(`${message.author.username}`, `${message.author.avatarURL({dynamic:true})}`)
