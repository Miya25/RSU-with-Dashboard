...
module.exports = {
name: "whitelist-add",
descrption: "White a User From Your Discord!",
...
.setDescription(new Discord.MessageEmbed().setAuthor(`${message.author.username}`, `${message.author.avatarURL({dynamic:true})}`) .setDescription(`${emoji.sucess} ${user} has been added in whiteList succesfully ${emoji.sucess}`).setColor(colors.uptime))
