...
if(!id.includes(message.author.id)) return message.channel.send(`${emoji.error} You cant bro`)
  ...
  message.channel.send(new Discord.MessageEmbed().setDescription(`${emoji.sucess} ${user_black} has Been \`${on_or_off ? "Unblacklisted" : "Blacklisted"}\``).setColor(colors.uptime));
