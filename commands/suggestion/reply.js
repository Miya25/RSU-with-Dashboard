...
if (channel === null) return;
    ...
    const number = new MessageEmbed()
      .setDescription(`${emoji.error} | I don't think that was a Message ID!`)
      .setColor("FF2052")
      
    const id = new MessageEmbed()
      .setDescription(`${emoji.error} |You forgot to specify Message ID!`)
      .setColor("FF2052")
      
    const query = new MessageEmbed()
      .setDescription(`${emoji.error} | You forgot to specify the Reply!`)
      .setColor("FF2052")
      
    const reply = new MessageEmbed()
      .setDescription(`${emoji.error} | Successfully Replied the Suggestion.`)
      .setColor("00FFFF")
      
    const noChannel = new MessageEmbed()
      .setDescription(`${emoji.error} | No Suggestion Channel found!`)
      .setColor("FF2052")
      
    const noMessage = new MessageEmbed()
      .setDescription(`${emoji.error} | Didn't find any Message with that ID!`)
      .setColor("FF2052")
  ...
  return message.channel.send(noMessage);
    ...
    const embed = new MessageEmbed()
      .setDescription(`You have got a Reply over your Suggestion ${emoji.sucess}. **[Message Link](https://discord.com/channels/${message.guild.id}/${channel}/${messageID})**`)
      .setColor("BLUE")
      user.send(embed)
